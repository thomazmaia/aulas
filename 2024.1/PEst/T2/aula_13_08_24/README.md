...
10. Crie um programa que ajude a organizar uma lista de tarefas. O programa deve permitir ao usuário adicionar novas tarefas, remover tarefas concluídas, e mover tarefas de uma posição para outra na lista. Além disso, o programa deve permitir que o usuário veja a lista de tarefas atualizada a qualquer momento.